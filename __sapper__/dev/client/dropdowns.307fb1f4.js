...
function create_default_slot(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t0 = claim_text(h30_nodes, "Пример");
			...
			t2 = claim_text(h31_nodes, "Пример");
		...
		h: function hydrate() {
			...
			add_location(h30, file, 131, 10, 4533);
			attr_dev(div0, "class", "col-xl-6");
			add_location(div0, file, 130, 4, 4499);
			attr_dev(h31, "class", "mt-4");
			add_location(h31, file, 134, 10, 4614);
			attr_dev(div1, "class", "col-xl-6");
			add_location(div1, file, 133, 5, 4580);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div0, anchor);
			append_dev(div0, h30);
