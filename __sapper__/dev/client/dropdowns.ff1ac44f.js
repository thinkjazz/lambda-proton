...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h4, "class", "mt-4");
			add_location(h4, file, 199, 10, 6496);
			attr_dev(div, "class", "col-xl-6");
