...
function create_default_slot(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(h4, "class", "mt-4");
			add_location(h4, file, 132, 10, 4573);
			attr_dev(div0, "class", "col-xl-6");
			add_location(div0, file, 130, 4, 4499);
			attr_dev(h31, "class", "mt-4");
			add_location(h31, file, 136, 10, 4666);
			attr_dev(div1, "class", "col-xl-6");
			add_location(div1, file, 135, 5, 4632);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div0, anchor);
			append_dev(div0, h30);
